...
<body style="background: #ECEBFF;">
		...
		<form action="boardList.bd" method="get" align="center">
				<select name="WhatColumn" class="column">
					...
					<div class="login">
						...
						<c:otherwise>
					<div class="login">
							<a href="" style="text-decoration: none;"><font color="blue">${myname}</font></a>님
					</div>
						</c:otherwise>
					</c:choose>
			</form>
  ...
  <link href="<%=request.getContextPath()%>/resources/assets/css/style.css" rel="stylesheet">
    ...
    <section id="services" class="services" style="background: white; height: 100%; width: 80%; margin: auto; margin-top: 60px; border-radius: 2%; margin-bottom: 30px;">
