   ...
   <section class="food_section layout_padding-bottom">
      ...
      <div class="container">
         <ul class="filters_menu">
            <li onclick="location.href='cafeInsert.cf'">추가</li>
            <li data-filter=".all">all</li>
            <li data-filter=".hotel" onclick="location.href='mainHotelList.ht'">호텔</li>
            <li data-filter=".pizza"
               onclick="location.href='mainRestaurantList.cf'">음식점</li>
         ...
         <form action="mainCafeList.cf" method="get" align="center">
                           ...
                           <div class="box">
                              <div>
                                 ...
                                 <div class="detail-box">
                                    ...
                                    <div class="options">
                                       <h6>연락처: ${list.ctel1} - ${list.ctel2} - ${list.ctel3}</h6>
                                    </div>
                                    <div class="options">
                                       <h6>${list.ctime1}시~${list.ctime2}시</h6>
                                    </div>
                                    <div align="right">
                                       <a href="cafeUpdate.cf?cnum=${list.cnum}"><font
                                          color="white">수정</font></a>&nbsp;&nbsp; 
                                          <a href="cafeDelete.cf?cnum=${list.cnum}">
